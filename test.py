...
data_path = "D:/Assets/Study/corals_classification/Bleached Corals and Healthy Corals Classification"  # todo 修改为数据集根目录
model_path = "../checkpoints/resnet50d_pretrained_224/resnet50d_11epochs_accuracy0.98688_weights.pth"  # todo 模型地址
