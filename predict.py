...
model_path = "../checkpoints/resnet50d_pretrained_224/resnet50d_11epochs_accuracy0.98688_weights.pth"  # todo  模型路径
classes_names = ['bleached_corals','healthy_corals']  # todo 类名
...
if __name__ == '__main__':
    ...
    predict_batch(model_path=model_path,
                  target_dir="D:/Assets/Study/corals_classification/bleached_corals",
                  save_dir="D:/Assets/Study/corals_classification/result")
    # 单张图片预测函数
    #predict_single(model_path=model_path, image_path="D:/Assets/Study/corals_classification/111/Validation/bleached_corals/1.jpg")
