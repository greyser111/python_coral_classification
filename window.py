...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        # 初始化界面
        super().__init__()
        self.setWindowTitle('珊瑚识别系统')
        self.resize(1200, 800)
        self.setWindowIcon(QIcon("images/UI/grey.jpg"))
        # 图片读取进程
        self.output_size = 480
        self.img2predict = ""
        self.origin_shape = ()

        self.model_path = "../checkpoints/resnet50d_pretrained_224/resnet50d_11epochs_accuracy0.98688_weights.pth"  # todo  模型路径
        # “雏菊”、“蒲公英”、“玫瑰”、“向日葵”、“郁金香”
        self.classes_names = ['白化珊瑚','健康珊瑚']  # todo 类名
        self.img_size = 224  # todo 图片大小
        self.model_name = "resnet50d"  # todo 模型名称
        self.num_classes = 2  # todo 类别数目
        # 加载网络
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        *** 关于界面 ***
        ...
        about_title = QLabel('欢迎使用基于Pytorch的珊瑚分类系统！\n\n')  # todo 修改欢迎词语
        about_title.setFont(QFont('楷体', 18))
        about_title.setAlignment(Qt.AlignCenter)
        about_img = QLabel()
        about_img.setPixmap(QPixmap('images/UI/R-C.jpg'))
        ...
        self.setTabIcon(0, QIcon('images/UI/grey.jpg'))
        self.setTabIcon(1, QIcon('images/UI/grey.jpg'))
